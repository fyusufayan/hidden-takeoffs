...
public class CustomResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler
    public final ResponseEntity<Object> handleTakeoffAlreadyExistsException(TakeoffAlreadyExistsException ex, WebRequest request){
        TakeoffAlreadyExistsExceptionResponse exceptionResponse=
                new TakeoffAlreadyExistsExceptionResponse(ex.getMessage());
